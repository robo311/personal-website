    ...
    <div className=''>
      <div className='fixed z-[10] hidden sm:block sm:left-5 md:left-8 lg:left-14 xl:left-16 2xl:left-23 bottom-0'>
        <ul className='text-[28px] flex flex-col gap-6'>
            ...
            <li className='hover:text-[#4AFFA8] transition duration-200 ease-out transform hover:translate-y-[-3px] p-[1px]'><a href="https://discordapp.com/users/842142913903067187"><FaDiscord/></a></li>
